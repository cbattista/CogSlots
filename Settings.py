...
class Settings:
	def __init__(self, name="unnamed", betsizes=[1, 2, 5, 10, 50], numPayouts=5, numReels=3, payouts=[20., 12., 10., 5., 3., 2., 1.], rounds=100, odds=85, autoodds=True, oddskind="equal", seed=20, debt=False, currency="$", probDict = {'obtain' : True, 'msg': "What do you think the odds of winning were?", 'interval' : 100, 'when' : "end"}, symbols=[cfg.IM_GOLDBARS, cfg.IM_TREASURECHEST, cfg.IM_BAR, cfg.IM_CHERRIES, cfg.IM_BELL, cfg.IM_CLOVER, cfg.IM_EMPTY, cfg.IM_BLANK], visibleSymbols = [cfg.IM_GOLDBARS, cfg.IM_TREASURECHEST, cfg.IM_BAR, cfg.IM_CHERRIES, cfg.IM_BELL], showPayouts = True, saveAs = "Subject", session=1):
